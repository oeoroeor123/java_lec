...
public class Class01_String {
  ...
  public static void method1() {
    ...
    System.out.println(str); // str = "abc", 나머지는 쓰레기값
  ...
  public static void method3() {
    ...
    String str1 = new String("a"); // new String을 사용하면 최적화가 아닌 새로운 참조값으로 새롭게 만들어짐
  ...
  public static void method4() {
    ...
    // equals           : 같은 문자열이면 true 반환 (완벽히 똑같은지 확인함)
  ...
  public static void method7() {
    ...
    System.out.println(str.indexOf(" ")); // 첫 번째 공백의 인덱스를 반환
    System.out.println(str.lastIndexOf(" ")); // 마지막 공백의 인덱스를 반환
  ...
  public static void method8() {
    ...
    System.out.println(str.substring(spaceIndex + 1)); // "world" 인자가 하나면 끝까지를 의미
    
    String str2 = "welcome home";
    
    int spaceIndex2 = str2.lastIndexOf(" ");
    
    System.out.println(str2.substring(0, spaceIndex2)); // "welcome"
    System.out.println(str2.substring(spaceIndex2 + 0)); // " home" : spaceIndex로 시작해 인덱스 0번부터 출력
  ...
  public static void method10() {
    ...
    // isEmpty : 글자가 아무것도 없으면(글자수가 0이면) true 반환
  ...
  public static void method12() {
    ...
    // .를 _로 바꾸기, 이스케이프 역슬래시를 앞에 한개 두고 뒤에 원하는 값을 작성 (\\. == \.)
  ...
  public static void method15() {
    ...
    System.out.println(String.format("%X", number2));    // 16진수(0~F)
    System.out.println(String.format("%d", number2));    // 10진수 정수 그대로 출력
    System.out.println(String.format("%5d", number2));   // 10진수 정수를 5자리로 맞추되 나머지는 공백으로 채워라 ("  123")
    System.out.println(String.format("%05d", number2));  // 10진수 정수를 5자리로 맞추되 나머지는 0으로 채워라 ("00123")
