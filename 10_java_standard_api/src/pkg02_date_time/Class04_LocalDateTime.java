...
public class Class04_LocalDateTime {
  ...
  /* LocalDateTime을 최근에 많이 쓰기 시작함, 잘 알아두기
   * LocalDate     : 날짜
   * LocalTime     : 시간
   * LocalDateTime : 둘다
   */
  ...
  public static void method1() {
    ...
    // 2. 특정 날짜와 시간
    // LocalDateTime.of : year년 month월 dayOfMonth일 날짜를 반환
    LocalDateTime dateTime2 = LocalDateTime.of(2024, 1, 18, 16, 13, 30, 123456789);
    System.out.println(dateTime2);
    
    // 3. 문자열 형식의 날짜와 시간
    // LocalDateTime.parse : 문자열 형식의 날짜를 LocalDate로 반환
  ...
  public static void method3() {
    ...
    // DateTimeFormatter.ofPattern : String 타입의 pattern을 적용한 DateTimeFormatter 객체 반환
